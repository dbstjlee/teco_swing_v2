...
public class LottoFrame extends JFrame implements ActionListener {
	...
	private LottoRandomNumber lottoRandomNumber; // 포함관계.. 메모리에 올라감.
	private boolean isStart = true; // 글자를 처음에 한번만 나오게 하고 싶을 때 boolean 사용
	...
	public void actionPerformed(ActionEvent e) {
		...
		isStart = false;
		repaint(); // 다시 그림을 그려라 요청하는 명령어 // F5 와 같은 명령어
